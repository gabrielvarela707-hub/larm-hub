...
const SYSTEM_RELEASES = [
...

  {
    ...
    description:
      "Integra a configuração Bradesco às empresas já cadastradas no sistema, centraliza a consulta de CEP e melhora a operação do cadastro de clientes sem alterar a lógica bancária existente.",
    ...
    architecture: {
      frontend: ["Next.js App Router", "Contas a Receber", "Cadastro de Clientes"],
      backend: ["Node.js", "Express.js", "Rotas de Cadastros", "Cobrança Bradesco preservada"],
      database: ["ts1_cemp", "tb2_cida", "tb2_esta", "cad_clientes", "cad_pessoas"],
      integrations: ["ViaCEP", "BrasilAPI", "Bradesco", "LARM", "LUCKY"],
    },
  },
