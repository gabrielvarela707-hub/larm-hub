...
const SYSTEM_RELEASES = [
  {
    ...
    description:
      "Corrige a prévia da posição de recebíveis usando a estrutura real da tabela legada fin_movimento, que não possui tenant_id.",
    ...
    architecture: {
      frontend: ["Sem alteração nesta versão"],
      backend: ["Node.js", "Seed de posição de recebíveis"],
      database: ["Sem alteração estrutural", "fin_movimento global", "com_parcelas por tenant"],
      integrations: ["PostgreSQL", "Contas a Receber", "LARM", "LUCKY"],
    },
  },

  {
    ...
    description:
      "Registra a primeira tentativa de correção da tipagem dos parâmetros; substituída pela versão 0.3.61 após a conferência do schema real.",
    frontend_version: "0.3.59",
    ...
    architecture: {
      frontend: ["Sem alteração nesta versão"],
      backend: ["Node.js", "Seed de posição de recebíveis"],
      database: ["Sem alteração estrutural", "fin_movimento", "com_parcelas"],
      integrations: ["PostgreSQL", "Contas a Receber", "LARM", "LUCKY"],
    },
  },

  {
    ...
    description:
      "Corrige a seleção da empresa bancária por obra, preserva os vínculos corretos dos lotes e adiciona um seed seguro para normalizar Contas a Receber até 23/06/2026.",
