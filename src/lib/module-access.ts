...
export const ROUTE_ACCESS: RouteRule[] = [
  ...
  { prefix: '/cadastros/fornecedores', modules: ['fin_fornecedores'] },
  { prefix: '/cadastros/clientes', modules: ['cadastros_clientes'] },
  ...
  { prefix: '/cadastros/atualizacao-indices', modules: ['cadastros_indices_economicos'] },
...
export function firstAccessibleHref(user: AuthUser | null | undefined) {
  const options = [
    ...
    { href: '/cadastros/fornecedores', modules: ['fin_fornecedores'] },
    { href: '/cadastros/clientes', modules: ['cadastros_clientes'] },
