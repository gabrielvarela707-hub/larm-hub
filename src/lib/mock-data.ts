...
export const mockLeads: Lead[] = [
  ...
  { id: 'lead_003', name: 'Roberto Carlos Machado', email: 'roberto@email.com', phone: '11997123456', status: 'qualificado', source: 'site', empreendimentoId: 'emp_001', score: 88, notes: 'Quer lote para construir em 2025', tags: ['quente', 'prioridade'], lastContactAt: '2024-07-12T10:00:00Z', createdAt: '2024-07-08T15:00:00Z' },
  ...
  { id: 'lead_006', name: 'Fernanda Oliveira Cruz', email: 'fernanda@email.com', phone: '11991234567', status: 'negociacao', source: 'portal', empreendimentoId: 'emp_001', score: 85, notes: 'Negociando desconto na entrada', tags: ['negociacao', 'desconto'], lastContactAt: '2024-07-15T11:00:00Z', createdAt: '2024-07-05T09:00:00Z' },
  ...
  { id: 'lead_008', name: 'Juliana Pereira Matos', email: 'juliana@email.com', phone: '62994567890', status: 'novo', source: 'instagram', empreendimentoId: 'emp_001', score: 40, notes: '', tags: [], lastContactAt: null, createdAt: '2024-07-15T08:00:00Z' },
...
export const mockContratos: Contrato[] = [
  { id: 'ct_001', number: '2024-001', buyerName: 'Paulo Henrique Dias', buyerCpf: '123.456.789-00', buyerEmail: 'paulo@email.com', buyerPhone: '62998765432', empreendimentoId: 'emp_001', empreendimentoName: 'Residencial Santa Clara', lotId: 'lot_007', lotDescription: 'Quadra A — Lote 07 — 320m²', totalValue: 280000, downPayment: 56000, installments: 120, installmentValue: 1870, status: 'assinado', signedAt: '2024-07-10T15:00:00Z', pdfUrl: '#', financingType: 'price', firstInstallmentDate: '2024-08-10', createdAt: '2024-07-10T14:00:00Z' },
  { id: 'ct_002', number: '2024-002', buyerName: 'Fernanda Oliveira Cruz', buyerCpf: '987.654.321-00', buyerEmail: 'fernanda@email.com', buyerPhone: '11991234567', empreendimentoId: 'emp_001', empreendimentoName: 'Residencial Santa Clara', lotId: 'lot_025', lotDescription: 'Quadra B — Lote 25 — 280m²', totalValue: 195000, downPayment: 29250, installments: 96, installmentValue: 1724, status: 'aguardando_assinatura', signedAt: null, pdfUrl: '#', financingType: 'sac', firstInstallmentDate: '2024-08-15', createdAt: '2024-07-14T10:00:00Z' },
  { id: 'ct_003', number: '2024-003', buyerName: 'Ana Carolina Souza', buyerCpf: '456.789.123-00', buyerEmail: 'ana@email.com', buyerPhone: '62992345678', empreendimentoId: 'emp_001', empreendimentoName: 'Residencial Santa Clara', lotId: 'lot_012', lotDescription: 'Quadra A — Lote 12 — 300m²', totalValue: 248000, downPayment: 37200, installments: 108, installmentValue: 1951, status: 'assinado', signedAt: '2024-06-20T11:00:00Z', pdfUrl: '#', financingType: 'price', firstInstallmentDate: '2024-07-20', createdAt: '2024-06-18T09:00:00Z' },
  { id: 'ct_004', number: '2023-089', buyerName: 'José Roberto Lima', buyerCpf: '321.654.987-00', buyerEmail: 'jose@email.com', buyerPhone: '62991111111', empreendimentoId: 'emp_001', empreendimentoName: 'Residencial Santa Clara', lotId: 'lot_045', lotDescription: 'Quadra C — Lote 45 — 450m²', totalValue: 520000, downPayment: 104000, installments: 120, installmentValue: 3467, status: 'quitado', signedAt: '2023-01-15T10:00:00Z', pdfUrl: '#', financingType: 'sacoc', firstInstallmentDate: '2023-02-15', createdAt: '2023-01-10T08:00:00Z' },
]
...
export const mockObras: Obra[] = [
  {
    ...
    empreendimentoName: 'Residencial Santa Clara',
    status: 'em_andamento',
    progress: 68,
