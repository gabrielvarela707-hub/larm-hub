...
BACKUP_DIR="$TARGET_DIR/backups/strato-0.8.2-$STAMP"
...
node "$RELEASE_DIR/scripts/test_strato_0_8_2.js"
...
install -D -m 0644 "$RELEASE_DIR/scripts/test_strato_0_8_2.js" "$TARGET_DIR/scripts/test_strato_0_8_2.js"
...
node -e "const p=require('./package.json'); if(p.version!=='0.8.2') throw new Error('package.json não ficou em 0.8.2'); console.log('Versão instalada:', p.version)"
node scripts/test_strato_0_8_2.js
...
echo
echo "Backend 0.8.2 instalado com sucesso."
echo "Backup: $BACKUP_DIR"
echo "Sem migration, sem npm install e sem atualização do frontend."
