...
assert(applySource.includes('nosso_numero=CASE WHEN $13::boolean THEN $14 ELSE nosso_numero END'))
assert(applySource.includes("analise_inteligente_strato_0_7_1"))

console.log('Conciliação Strato 0.7.1: DV, boleto reemitido, frações equivalentes, juros/moras e seleção persistente conferidos.')
