...
async function main() {
  ...
  assert.strictEqual(releases[0].version, '0.7.1')
  ...
  console.log('Análise inteligente Strato 0.7.1: multiparcelas, descontos, arredondamento, cadastros e bloqueio de escrita conferidos.')
}
