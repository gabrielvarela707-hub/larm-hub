...
const fornecedorContratosRoutes = require('./routes/fornecedor_contratos')
...
app.use('/financeiro', indicesEconomicosRoutes)
app.use('/financeiro/fornecedores', fornecedorContratosRoutes)
app.use('/',       usersRoutes)
